...
function GenerateCheckBox(props) {
    ...
    return (
        ...
        >
            ...
            />
            <Text style={{ marginLeft: 15, color: "#B7BBBB", fontFamily: "Jura" }}>{props.text}</Text>
        </View>
    );
}
...
function Dashboard() {
    ...
    return (
        ...
        >
            ...
            <View style={{ paddingVertical: 24, paddingHorizontal: 25, }}>
                ...
                >
                    ...
                    <View>
                        ...
                        <TaskStatusItem color="#75C9A8" title="DONE" stage={true} count={series[2]} />
                    </View>
                </View>
            </View>
            {/* todo list container */}
            ...
            <View
                style={{ marginTop: 30, ...styles.containerBox }}
            >
